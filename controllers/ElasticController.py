...
class ElasticController(BaseController):
    ...
    def __init__(self):
        ...
        self.queue_target = 8 #40 10 seems to be ok with 20 average is 2.8
        self.k1 = 0.02
        self.k2 = 0.001
        self.t_last = -1
    ...
    def calcControlAction(self):
        if 0==1:#self.maliciousFlag == 1:
        	self.setIdleDuration(0.5) #0.0 adeel
		y = float(self.feedback['max_rate']*1.1) #1.5 adeel
