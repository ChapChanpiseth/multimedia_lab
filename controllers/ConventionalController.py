...
class ConventionalController(BaseController):
    ...
    def __init__(self):
        ...
        self.Q = 15 #seconds
        #self.alpha = 0.8 #0.2 #Ewma filter # smooth bandwidth # as long as alpha increases the result is a bit naive cuz the video rate is token into account as the next chunk to download. the smaller the bandwidth is the the result is appraoching the buffer base.
        self.alpha = 0.2
        self.eps = 0.15
